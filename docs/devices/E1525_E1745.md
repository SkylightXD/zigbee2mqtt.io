...
Check the charge of the batteries. It does not work at my side with 13%, but with new fresh batteries it works!

1. Remove both batteries of the E1745.
2. Press an hold the paring button.
3. Insert the frist battery.
4. Start the update process in Zigbee2MQTT.
5. Insert the second battery.
